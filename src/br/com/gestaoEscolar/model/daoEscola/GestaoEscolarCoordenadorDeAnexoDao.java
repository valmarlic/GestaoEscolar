...
public class GestaoEscolarCoordenadorDeAnexoDao {

	public List<GestaoEscolarCoordenadorDeAnexoDao> getFornecedores() throws SQLException, ClassNotFoundException {
		...
		List<GestaoEscolarCoordenadorDeAnexoDao> fornecedores = new ArrayList<>();
		while (rs.next()) {
	...
	public void salvar(GestaoEscolarCoordenadorDeAnexo fornecedor) throws SQLException, ClassNotFoundException {
		System.out.println();
		...
		try {
			...
			PreparedStatement statement = conexao.prepareStatement(
					"INSERT INTO coordenador_de_anexo(nome_coord_de_anexo, cpf_coord_de_anexo, e_mail_coord_de_nexo,criterio_de_acesso_cargo_funcao,"
							+ "situacao_funcional_coord_de_anexo, carga_horaria_cood_de_anexo,turno_coord_de_anexo,"
							+ "data_cadastral_coord_de_anexo) VALUES(?,?,?,?,?,?,?,?)");

			statement.setString(1, fornecedor.getNomeCoordDeAnexo());
			statement.setString(2, fornecedor.getCpfCoordDeAnexo());
			statement.setString(3, fornecedor.getEmailCoordDeAnexo());
			statement.setString(4, fornecedor.getCriterioAcessoCoordDeAnexo());
			statement.setString(5, fornecedor.getSituacaoFuncionalCoordDeAnexo());
			statement.setString(6, fornecedor.getCargaHorariaCoordDeAnexo());
			statement.setString(7, fornecedor.getTurnoCoordDeAnexo());
			statement.setObject(8, fornecedor.getDataCadrstralCoordDeAnexo());
	...
	public GestaoEscolarCoordenadorDeAnexo getFornecedorId(Integer codFornecedor)
	...
	public void atualizar(GestaoEscolarCoordenadorDeAnexo fornecedor) throws SQLException, ClassNotFoundException {
		Connection conexao = ConexaoJDBCFactory.getConexao();
		PreparedStatement statement = conexao.prepareStatement(
